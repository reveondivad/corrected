...
filter = ""(uid="" + Server.HTMLEncode(CStr(userName)) + "")"" ' searching for the user entry
...
While ldapObj.NextResult = 1
	Response.Write(""<p>"")
	Response.Write(""<b><i>User information for: "" + Server.HTMLEncode(ldapObj.AttrValue(0)) + ""</i></b><br>"")
	For i = 0 To ldapObj.AttrCount -1
		Response.Write(""<b>"" + Server.HTMLEncode(ldapObj.AttrType(i)) +""</b>: "" + Server.HTMLEncode(ldapObj.AttrValue(i)) + ""<br>"" )
	Next
	Response.Write(""</p>"")
Wend
Response.Write(""<b>"" + Server.HTMLEncode(ldapObj.AttrType(i)) +""</b>: "" + Server.HTMLEncode(ldapObj.AttrValue(i)) + ""<br>"" )